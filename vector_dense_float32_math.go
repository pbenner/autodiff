...
func (r DenseFloat32Vector) VADDV(a, b DenseFloat32Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VADDS(a DenseFloat32Vector, b Float32) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VSUBV(a, b DenseFloat32Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VSUBS(a DenseFloat32Vector, b Float32) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VMULV(a, b DenseFloat32Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VMULS(a DenseFloat32Vector, s Float32) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VDIVV(a, b DenseFloat32Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) VDIVS(a DenseFloat32Vector, s Float32) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat32Vector) MDOTV(a *DenseFloat32Matrix, b DenseFloat32Vector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
    panic("matrix/vector dimensions do not match!")
  }
...
func (r DenseFloat32Vector) VDOTM(a DenseFloat32Vector, b *DenseFloat32Matrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
