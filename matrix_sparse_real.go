...
func (obj *SparseRealMatrix) ConstIteratorFrom(i, j int) MatrixConstIterator {
...
func (obj *SparseRealMatrix) IteratorFrom(i, j int) MatrixIterator {
  return obj.ITERATOR_FROM(i, j)
}
...
func (obj *SparseRealMatrix) ITERATOR_FROM(i, j int) *SparseRealMatrixIterator {
  k := obj.index(i, j)
  r := SparseRealMatrixIterator{*obj.values.ITERATOR_FROM(k), obj}
  return &r
}
...
func (obj *SparseRealMatrix) JOINT3_ITERATOR(b, c ConstMatrix) *SparseRealMatrixJoint3Iterator {
  r := SparseRealMatrixJoint3Iterator{obj.ITERATOR(), b.ConstIterator(), c.ConstIterator(), -1, -1, nil, nil, nil}
  r.Next()
  return &r
}
/* iterator
...
/* joint iterator
 * -------------------------------------------------------------------------- */
type SparseRealMatrixJointIterator struct {
  it1 *SparseRealMatrixIterator
  it2 MatrixConstIterator
  i, j int
  s1 *Real
  s2 ConstScalar
}
func (obj *SparseRealMatrixJointIterator) Index() (int, int) {
  return obj.i, obj.j
}
...
func (obj *SparseRealMatrixJointIterator) Get() (Scalar, ConstScalar) {
  if obj.s1 == nil {
    return nil, obj.s2
  } else {
...
func (obj *SparseRealMatrixJointIterator) GetConst() (ConstScalar, ConstScalar) {
  if obj.s1 == nil {
    return nil, obj.s2
  } else {
    return obj.s1, obj.s2
...
func (obj *SparseRealMatrixJointIterator) GetValue() (float64, float64) {
  v1 := 0.0
  v2 := 0.0
  if obj.s1 != nil {
    v1 = obj.s1.GetValue()
...
func (obj *SparseRealMatrixJointIterator) GET() (*Real, ConstScalar) {
  return obj.s1, obj.s2
}
func (obj *SparseRealMatrixJointIterator) Clone() *SparseRealMatrixJointIterator {
  r := SparseRealMatrixJointIterator{}
  r.it1 = obj.it1.Clone()
...
/* joint3 iterator
 * -------------------------------------------------------------------------- */
type SparseRealMatrixJoint3Iterator struct {
  it1 *SparseRealMatrixIterator
  it2 MatrixConstIterator
...
func (obj *SparseRealMatrixJoint3Iterator) Index() (int, int) {
  return obj.i, obj.j
}
func (obj *SparseRealMatrixJoint3Iterator) Ok() bool {
  return !(obj.s1 == nil || obj.s1.GetValue() == 0.0) ||
         !(obj.s2 == nil || obj.s2.GetValue() == 0.0) ||
         !(obj.s3 == nil || obj.s3.GetValue() == 0.0)
}
func (obj *SparseRealMatrixJoint3Iterator) Next() {
  ok1 := obj.it1.Ok()
  ok2 := obj.it2.Ok()
  ok3 := obj.it3.Ok()
  obj.s1 = nil
...
func (obj *SparseRealMatrixJoint3Iterator) Get() (Scalar, ConstScalar, ConstScalar) {
  if obj.s1 == nil {
...
func (obj *SparseRealMatrixJoint3Iterator) GET() (*Real, ConstScalar, ConstScalar) {
  return obj.s1, obj.s2, obj.s3
}
