...
func (obj ConstGradientDense) update(g2 ConstGradientDense, v DenseFloat64Vector) {
  c := g2.w - obj.w
...
func (obj ConstGradientDense) add(v DenseFloat64Vector) {
  for it := obj.g.ITERATOR(); it.Ok(); it.Next() {
    s_a := v.AT(it.Index())
    s_b := it.GET()
...
func (obj *ConstGradientDense) set(w float64, g DenseFloat64Vector) {
  obj.g = g
  obj.w = w
}
/* -------------------------------------------------------------------------- */
...
func (obj GradientDense) add(v DenseFloat64Vector) {
  for it := obj.g.ITERATOR(); it.Ok(); it.Next() {
    s_a := v.AT(it.Index())
    s_b := it.GET()
...
func (obj GradientDense) sub(v DenseFloat64Vector) {
  for it := obj.g.ITERATOR(); it.Ok(); it.Next() {
    s_a := v.AT(it.Index())
    s_b := it.GET()
    s_a.SetFloat64(s_a.GetFloat64() - s_b.GetFloat64())
