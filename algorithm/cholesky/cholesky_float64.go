...
/* -------------------------------------------------------------------------- */
func cholesky_float64(A *DenseFloat64Matrix, L *DenseFloat64Matrix, s, t Float64) (*DenseFloat64Matrix, *DenseFloat64Matrix, error) {
  n, _ := A.Dims()
  for i := 0; i < n; i++ {
    for j := 0; j < (i+1); j++ {
      s.Reset()
...
func cholesky_ldl_float64(A *DenseFloat64Matrix, L, D *DenseFloat64Matrix, s, t Float64) (*DenseFloat64Matrix, *DenseFloat64Matrix, error) {
  n, _ := A.Dims()
  c := t
  for j := 0; j < n; j++ {
...
func cholesky_ldl_forcepd_float64(A *DenseFloat64Matrix, L, D *DenseFloat64Matrix, s, t Float64) (*DenseFloat64Matrix, *DenseFloat64Matrix, error) {
  n, _ := A.Dims()
