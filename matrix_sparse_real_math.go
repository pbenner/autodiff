...
func (a *SparseRealMatrix) Equals(b ConstMatrix, epsilon float64) bool {
	n1, m1 := a.Dims()
	n2, m2 := b.Dims()
	if n1 != n2 || m1 != m2 {
...
func (r *SparseRealMatrix) MaddM(a, b ConstMatrix) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	n2, m2 := b.Dims()
...
func (r *SparseRealMatrix) MaddS(a ConstMatrix, b ConstScalar) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	if n1 != n || m1 != m {
		panic("matrix dimensions do not match!")
...
func (r *SparseRealMatrix) MsubM(a, b ConstMatrix) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	n2, m2 := b.Dims()
	if n1 != n || m1 != m || n2 != n || m2 != m {
...
func (r *SparseRealMatrix) MsubS(a ConstMatrix, b ConstScalar) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	if n1 != n || m1 != m {
		panic("matrix dimensions do not match!")
...
func (r *SparseRealMatrix) MmulM(a, b ConstMatrix) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	n2, m2 := b.Dims()
	if n1 != n || m1 != m || n2 != n || m2 != m {
...
func (r *SparseRealMatrix) MmulS(a ConstMatrix, b ConstScalar) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	if n1 != n || m1 != m {
		panic("matrix dimensions do not match!")
...
func (r *SparseRealMatrix) MdivM(a, b ConstMatrix) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	n2, m2 := b.Dims()
	if n1 != n || m1 != m || n2 != n || m2 != m {
...
func (r *SparseRealMatrix) MdivS(a ConstMatrix, b ConstScalar) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	if n1 != n || m1 != m {
		panic("matrix dimensions do not match!")
...
func (r *SparseRealMatrix) MdotM(a, b ConstMatrix) Matrix {
	n, m := r.Dims()
	n1, m1 := a.Dims()
	n2, m2 := b.Dims()
	if n1 != n || m2 != m || m1 != n2 {
	...
	if r.storageLocation() == b.storageLocation() {
		t3 := r.tmp1.Slice(0, n).(*SparseRealVector)
		for j := 0; j < m; j++ {
			for i := 0; i < n; i++ {
				t2.Reset()
				for k := 0; k < m1; k++ {
		...
		t3 := r.tmp2.Slice(0, m).(*SparseRealVector)
		for i := 0; i < n; i++ {
			for j := 0; j < m; j++ {
				t2.Reset()
				for k := 0; k < m1; k++ {
...
func (r *SparseRealMatrix) Outer(a, b ConstVector) Matrix {
	n, m := r.Dims()
	if a.Dim() != n || b.Dim() != m {
...
func (r *SparseRealMatrix) Jacobian(f func(ConstVector) ConstVector, x_ Vector) Matrix {
	n, m := r.Dims()
	x := x_.CloneVector()
	x.Variables(1)
	// compute Jacobian
...
func (r *SparseRealMatrix) Hessian(f func(ConstVector) ConstScalar, x_ Vector) Matrix {
	n, m := r.Dims()
	// reallocate matrix if dimensions do not match
