...
func NewSparseConstInt64Vector(indices []int, values []int64, n int) SparseConstInt64Vector {
  ...
  sort.Sort(sortIntConstInt64{indices, values})
  r := nilSparseConstInt64Vector(n)
  r.indices = indices[0:0]
  r.values = make([]int64, 0, len(values))
...
func nilSparseConstInt64Vector(n int) SparseConstInt64Vector {
  r := SparseConstInt64Vector{}
  r.n = n
...
func AsSparseConstInt64Vector(v ConstVector) SparseConstInt64Vector {
  ...
  for it := v.ConstIterator(); it.Ok(); it.Next() {
    ...
    values = append(values, it.GetConst().GetInt64())
  }
  return NewSparseConstInt64Vector(indices, values, n)
}
/* cloning
 * -------------------------------------------------------------------------- */
func (obj SparseConstInt64Vector) Clone() SparseConstInt64Vector {
  r := nilSparseConstInt64Vector(obj.n)
...
func (obj SparseConstInt64Vector) First() (int, ConstInt64) {
  return obj.indices[0], ConstInt64(obj.values[0])
}
func (obj SparseConstInt64Vector) Last() (int, ConstInt64) {
  i := len(obj.indices) - 1
  return obj.indices[i], ConstInt64(obj.values[i])
}
...
func (obj SparseConstInt64Vector) ConstSlice(i, j int) ConstVector {
  if i == 0 {
    ...
    k2 := sort.SearchInts(obj.indices, j)
    r := nilSparseConstInt64Vector(j-i)
    r.values = obj.values[k1:k2]
...
func (obj SparseConstInt64Vector) ConstJointIterator(b ConstVector) VectorConstJointIterator {
  return obj.JOINT_ITERATOR(b)
}
func (obj SparseConstInt64Vector) ITERATOR() *SparseConstInt64VectorIterator {
  r := SparseConstInt64VectorIterator{0, obj}
  return &r
}
func (obj SparseConstInt64Vector) ITERATOR_FROM(i int) *SparseConstInt64VectorIterator {
  k := 0
  ...
  r := SparseConstInt64VectorIterator{k, obj}
  return &r
}
func (obj SparseConstInt64Vector) JOINT_ITERATOR(b ConstVector) *SparseConstInt64VectorJointIterator {
  r := SparseConstInt64VectorJointIterator{}
  r.it1 = obj.ITERATOR()
...
func (obj SparseConstInt64Vector) Table() string {
  ...
  if len(obj.indices) > 0 {
    if i := obj.indices[len(obj.indices)-1]; i != obj.n-1 {
      buffer.WriteString(fmt.Sprintf(" %d:%v", i, int64(0)))
    }
  }
  return buffer.String()
}
...
type SparseConstInt64VectorIterator struct {
  i int
  v SparseConstInt64Vector
}
func (obj *SparseConstInt64VectorIterator) GetConst() ConstScalar {
  return obj.GET()
}
func (obj *SparseConstInt64VectorIterator) GET() ConstInt64 {
  return ConstInt64(obj.v.values[obj.i])
}
func (obj *SparseConstInt64VectorIterator) Ok() bool {
...
func (obj *SparseConstInt64VectorIterator) Clone() *SparseConstInt64VectorIterator {
  return &SparseConstInt64VectorIterator{obj.i, obj.v}
}
...
type SparseConstInt64VectorJointIterator struct {
  it1 *SparseConstInt64VectorIterator
  it2 VectorConstIterator
  idx int
  s1 ConstInt64
  s2 ConstScalar
}
func (obj *SparseConstInt64VectorJointIterator) Index() int {
  return obj.idx
}
func (obj *SparseConstInt64VectorJointIterator) Ok() bool {
  return !(obj.s1.GetInt64() == int64(0)) ||
         !(obj.s2.GetInt64() == int64(0))
}
func (obj *SparseConstInt64VectorJointIterator) Next() {
  ok1 := obj.it1.Ok()
  ok2 := obj.it2.Ok()
  obj.s1 = ConstInt64(0)
  obj.s2 = ConstInt64(0)
  ...
  if obj.s1 != ConstInt64(0) {
    obj.it1.Next()
  }
  if obj.s2 != ConstInt64(0) {
    obj.it2.Next()
  } else {
    obj.s2 = ConstInt64(0.0)
  }
}
func (obj *SparseConstInt64VectorJointIterator) GetConst() (ConstScalar, ConstScalar) {
  return obj.s1, obj.s2
}
func (obj *SparseConstInt64VectorJointIterator) GET() (ConstInt64, ConstScalar) {
  return obj.s1, obj.s2
}
