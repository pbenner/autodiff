...
func (r *SparseReal32Vector) VADDV(a, b *SparseReal32Vector) *SparseReal32Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal32Vector) VaddS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal32Vector) VADDS(a *SparseReal32Vector, b *Real32) *SparseReal32Vector {
  r.VaddS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseReal32Vector) VSUBV(a, b *SparseReal32Vector) *SparseReal32Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseReal32Vector) VsubS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal32Vector) VSUBS(a *SparseReal32Vector, b *Real32) *SparseReal32Vector {
  r.VsubS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseReal32Vector) VMULV(a, b *SparseReal32Vector) *SparseReal32Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseReal32Vector) VmulS(a ConstVector, b ConstScalar) Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal32Vector) VMULS(a *SparseReal32Vector, b *Real32) *SparseReal32Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal32Vector) VDIVV(a, b *SparseReal32Vector) *SparseReal32Vector {
  r.VdivV(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
// Element-wise division of a vector and a scalar. The result is stored in r.
func (r *SparseReal32Vector) VdivS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal32Vector) VDIVS(a *SparseReal32Vector, b *Real32) *SparseReal32Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT_ITERATOR_(a); it.Ok(); it.Next() {
...
func (r *SparseReal32Vector) MdotV(a ConstMatrix, b ConstVector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
...
func (r *SparseReal32Vector) VdotM(a ConstVector, b ConstMatrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
