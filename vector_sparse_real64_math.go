...
func (r *SparseReal64Vector) VADDV(a, b *SparseReal64Vector) *SparseReal64Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal64Vector) VaddS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal64Vector) VADDS(a *SparseReal64Vector, b *Real64) *SparseReal64Vector {
  r.VaddS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseReal64Vector) VSUBV(a, b *SparseReal64Vector) *SparseReal64Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseReal64Vector) VsubS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal64Vector) VSUBS(a *SparseReal64Vector, b *Real64) *SparseReal64Vector {
  r.VsubS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseReal64Vector) VMULV(a, b *SparseReal64Vector) *SparseReal64Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseReal64Vector) VmulS(a ConstVector, b ConstScalar) Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal64Vector) VMULS(a *SparseReal64Vector, b *Real64) *SparseReal64Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal64Vector) VDIVV(a, b *SparseReal64Vector) *SparseReal64Vector {
  r.VdivV(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
// Element-wise division of a vector and a scalar. The result is stored in r.
func (r *SparseReal64Vector) VdivS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseReal64Vector) VDIVS(a *SparseReal64Vector, b *Real64) *SparseReal64Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT_ITERATOR_(a); it.Ok(); it.Next() {
...
func (r *SparseReal64Vector) MdotV(a ConstMatrix, b ConstVector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
...
func (r *SparseReal64Vector) VdotM(a ConstVector, b ConstMatrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
