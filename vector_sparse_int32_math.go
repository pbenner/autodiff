...
func (r *SparseInt32Vector) VADDV(a, b *SparseInt32Vector) *SparseInt32Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt32Vector) VaddS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt32Vector) VADDS(a *SparseInt32Vector, b Int32) *SparseInt32Vector {
  r.VaddS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseInt32Vector) VSUBV(a, b *SparseInt32Vector) *SparseInt32Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseInt32Vector) VsubS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt32Vector) VSUBS(a *SparseInt32Vector, b Int32) *SparseInt32Vector {
  r.VsubS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseInt32Vector) VMULV(a, b *SparseInt32Vector) *SparseInt32Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseInt32Vector) VmulS(a ConstVector, b ConstScalar) Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt32Vector) VMULS(a *SparseInt32Vector, b Int32) *SparseInt32Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt32Vector) VDIVV(a, b *SparseInt32Vector) *SparseInt32Vector {
  r.VdivV(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
// Element-wise division of a vector and a scalar. The result is stored in r.
func (r *SparseInt32Vector) VdivS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt32Vector) VDIVS(a *SparseInt32Vector, b Int32) *SparseInt32Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT_ITERATOR_(a); it.Ok(); it.Next() {
...
func (r *SparseInt32Vector) MdotV(a ConstMatrix, b ConstVector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
...
func (r *SparseInt32Vector) VdotM(a ConstVector, b ConstMatrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
