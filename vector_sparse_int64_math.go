...
func (r *SparseInt64Vector) VADDV(a, b *SparseInt64Vector) *SparseInt64Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt64Vector) VaddS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt64Vector) VADDS(a *SparseInt64Vector, b Int64) *SparseInt64Vector {
  r.VaddS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseInt64Vector) VSUBV(a, b *SparseInt64Vector) *SparseInt64Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseInt64Vector) VsubS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt64Vector) VSUBS(a *SparseInt64Vector, b Int64) *SparseInt64Vector {
  r.VsubS(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
...
func (r *SparseInt64Vector) VMULV(a, b *SparseInt64Vector) *SparseInt64Vector {
  if n := r.Dim(); a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT3_ITERATOR_(a, b); it.Ok(); it.Next() {
...
func (r *SparseInt64Vector) VmulS(a ConstVector, b ConstScalar) Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt64Vector) VMULS(a *SparseInt64Vector, b Int64) *SparseInt64Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt64Vector) VDIVV(a, b *SparseInt64Vector) *SparseInt64Vector {
  r.VdivV(a, b)
  return r
}
/* -------------------------------------------------------------------------- */
// Element-wise division of a vector and a scalar. The result is stored in r.
func (r *SparseInt64Vector) VdivS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if n != a.Dim() {
    panic("vector dimensions do not match")
  }
...
func (r *SparseInt64Vector) VDIVS(a *SparseInt64Vector, b Int64) *SparseInt64Vector {
  if r.Dim() != a.Dim() {
    panic("vector dimensions do not match")
  }
  for it := r.JOINT_ITERATOR_(a); it.Ok(); it.Next() {
...
func (r *SparseInt64Vector) MdotV(a ConstMatrix, b ConstVector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
...
func (r *SparseInt64Vector) VdotM(a ConstVector, b ConstMatrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
