...
func (r DenseFloat64Vector) VADDV(a, b DenseFloat64Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VaddS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VADDS(a DenseFloat64Vector, b Float64) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VSUBV(a, b DenseFloat64Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VsubS(a ConstVector, b ConstScalar) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VSUBS(a DenseFloat64Vector, b Float64) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VMULV(a, b DenseFloat64Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VmulS(a ConstVector, s ConstScalar) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VMULS(a DenseFloat64Vector, s Float64) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VDIVV(a, b DenseFloat64Vector) Vector {
  n := r.Dim()
  if a.Dim() != n || b.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VdivS(a ConstVector, s ConstScalar) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) VDIVS(a DenseFloat64Vector, s Float64) Vector {
  n := r.Dim()
  if a.Dim() != n {
    panic("vector dimensions do not match")
  }
...
func (r DenseFloat64Vector) MdotV(a ConstMatrix, b ConstVector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
...
func (r DenseFloat64Vector) MDOTV(a *DenseFloat64Matrix, b DenseFloat64Vector) Vector {
  n, m := a.Dims()
  if r.Dim() != n || b.Dim() != m {
    panic("matrix/vector dimensions do not match!")
  }
...
func (r DenseFloat64Vector) VdotM(a ConstVector, b ConstMatrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
...
func (r DenseFloat64Vector) VDOTM(a DenseFloat64Vector, b *DenseFloat64Matrix) Vector {
  n, m := b.Dims()
  if r.Dim() != m || a.Dim() != n {
    panic("matrix/vector dimensions do not match!")
  }
