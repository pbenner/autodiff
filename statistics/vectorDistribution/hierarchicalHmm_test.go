...
func TestHhmm1(test *testing.T) {
  ...
  sr := NewDenseFloat64Matrix([]float64{
    ...
    2.300000e-01, 2.300000e-01, 2.612903e-01, 2.787097e-01}, 4, 4)
  ...
  if t.Mnorm(sr.MsubM(hmm.Tr, sr)).GetFloat64() > 1e-8 {
    test.Error("test failed")
  }
}

func TestHhmm2(test *testing.T) {
  // HMM definition
  //////////////////////////////////////////////////////////////////////////////
  t  := NewFloat64(0.0)
  pi := NewDenseFloat64Vector([]float64{1, 1, 1, 1, 1, 1})
  ...
  sr := NewDenseFloat64Matrix([]float64{
    ...
    1.551724e-01, 1.551724e-01, 1.551724e-01, 1.551724e-01, 1.847922e-01, 1.945181e-01 }, 6, 6)
  sr.Map(func(a Scalar) { a.Log(a) })
...
func TestHhmm3(test *testing.T) {
  ...
  if hhmm2, err := ImportVectorPdf(filename, Float64Type); err != nil {
    test.Error(err); return
  } else {
