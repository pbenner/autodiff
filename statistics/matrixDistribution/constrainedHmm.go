...
func NewConstrainedHmm(pi Vector, tr Matrix, stateMap []int, edist []VectorPdf, tree generic.HmmNode) (*Chmm, error) {
  return newConstrainedHmm(pi, tr, stateMap, edist, tree, false)
}

func newConstrainedHmm(pi Vector, tr Matrix, stateMap []int, edist []VectorPdf, tree generic.HmmNode, isLog bool) (*Chmm, error) {
...
func (obj *Chmm) ExportConfig() ConfigDistribution {
  ...
  return NewConfigDistribution("matrix:hierarchical hmm distribution", parameters, configHmm.Distributions...)
}
