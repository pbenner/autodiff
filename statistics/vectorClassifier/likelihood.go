...
func NewPosteriorClassifier(fgDist VectorPdf, bgDist VectorPdf, weights [2]float64, args... interface{}) (*PosteriorClassifier, error) {
  if classifier, err := NewLikelihoodClassifier(fgDist, bgDist, args...); err != nil {
    return nil, err
  } else {
...
func NewPosteriorOddsClassifier(fgDist VectorPdf, bgDist VectorPdf, weights [2]float64, args... interface{}) (*PosteriorOddsClassifier, error) {
