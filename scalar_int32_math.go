...
func (c Int32) Sigmoid(a ConstScalar, t Scalar) Scalar {
  if a.GetFloat64() >= 0 {
    c.Neg(a)
    c.Exp(c)
    c.Add(c, ConstInt32(1.0))
    c.Div(ConstInt32(1.0), c)
  } else {
    t.Exp(a)
    c.Set(t)
    t.Add(t, ConstInt32(1.0))
    c.Div(c, t)
  }
  return c
}
...
func (r Int32) Vmean(a ConstVector) Scalar {
  ...
  return r.Div(r, ConstInt32(float64(a.Dim())))
}
...
func (r Int32) Vnorm(a ConstVector) Scalar {
  ...
  for it := a.ConstIterator(); it.Ok(); it.Next() {
    t.Pow(it.GetConst(), ConstInt32(2.0))
    r.Add(r, t)
  }
  r.Sqrt(r)
  return r
...
func (r Int32) Mnorm(a ConstMatrix) Scalar {
  ...
  v := a.AsConstVector()
  r.Pow(v.ConstAt(0), ConstInt32(2.0))
  for i := 1; i < v.Dim(); i++ {
    t.Pow(v.ConstAt(i), ConstInt32(2.0))
    r.Add(r, t)
  }
  return r
}
